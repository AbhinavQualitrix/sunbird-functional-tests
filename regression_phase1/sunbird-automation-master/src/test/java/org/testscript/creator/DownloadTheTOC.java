...
public class DownloadTheTOC extends BaseTest{
	
	@Test(groups= {"regression1"})
	public void downloadTheTOC() throws Exception {
		...
		//Step 3:Download TOC
		String ext = bookEditorPageObj.download_TOC(objListOFTestDataForSunbird);
